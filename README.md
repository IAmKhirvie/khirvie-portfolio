...
- Public GitHub projects are represented from `github.com/IAmKhirvie`.
- Recognition content is excluded from the portfolio.
- Certifications/credentials currently listed: CCNA 1, CCNA 2, CCNA 3, Bachelor of Science in Information Technology (BSIT), and High School Diploma - ICT Specialization in Programming.
- Live demo links are intentionally removed.
